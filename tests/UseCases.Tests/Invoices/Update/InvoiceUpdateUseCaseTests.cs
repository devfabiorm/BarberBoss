...
public class InvoiceUpdateUseCaseTests
{
    ...
    public InvoiceUpdateUseCase CreateUseCase(Invoice invoice, User user)
    {
        var repository = new UpdateOnlyInvoiceRepositoryBuilder()
        ...
        return new InvoiceUpdateUseCase(repository, mapper, unitOfWork, loggedUser);
    }
}
